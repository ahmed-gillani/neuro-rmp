...
export default function MonitoringTab({ patient }: MonitoringTabProps) {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h3 className="text-2xl md:text-3xl font-bold text-gray-900">Monitoring</h3>
        <p className="text-gray-600 mt-1">Create and manage monitoring entries for the patient in one place.</p>
      </div>
          ...
          <div className="p-5 sm:p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-8">
              <div>
                ...
                <input 
                  ...
                  className="w-full text-center text-3xl sm:text-4xl font-bold border border-gray-200 rounded-2xl p-4 focus:outline-none focus:ring-2 focus:ring-blue-500" 
                />
              </div>
              <div>
                <p className="text-xs font-bold text-gray-500 mb-2">Minutes</p>
            ...
            <div className="mb-6">
              ...
              <input 
                ...
                className="w-full border border-gray-200 rounded-2xl p-4 text-base" 
              />
            </div>
            ...
            <div className="mb-6">
              ...
              <textarea
                ...
                onChange={(e) => setCustomNote(e.target.value)}
                placeholder="Enter your notes here..."
                className="w-full h-28 sm:h-32 border border-gray-200 rounded-3xl p-5 resize-y focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
            </div>

            <Button onClick={handleSave} className="w-full py-5 sm:py-6 text-base shadow-lg">
              Save Monitoring Entry
            </Button>
          </div>
        </Card>
        ...
        <Card title="Monitoring History">
          <div className="overflow-x-auto">
            <table className="w-full min-w-[640px] md:min-w-0">
              <thead>
                <tr className="border-b border-gray-200 bg-gray-50">
                  <th className="text-left py-4 px-4 sm:px-6 font-bold text-xs text-gray-700">DATE</th>
                  <th className="text-left py-4 px-4 sm:px-6 font-bold text-xs text-gray-700">TIME</th>
                  <th className="text-left py-4 px-4 sm:px-6 font-bold text-xs text-gray-700">NOTE</th>
                  <th className="text-center py-4 px-4 sm:px-6 font-bold text-xs text-gray-700">ACTIONS</th>
                </tr>
              </thead>
              <tbody className="divide-y">
                {history.map((entry) => (
                  <tr key={entry.id} className="hover:bg-gray-50 transition-colors">
                    <td className="py-5 px-4 sm:px-6 text-gray-900 font-medium whitespace-nowrap">{entry.date}</td>
                    <td className="py-5 px-4 sm:px-6 text-gray-900 font-mono whitespace-nowrap">{entry.time}</td>
                    <td className="py-5 px-4 sm:px-6 text-gray-700 max-w-xs truncate">{entry.note}</td>
