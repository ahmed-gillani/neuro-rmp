    ...
    <div className="bg-white border border-slate-100 rounded-xl p-3.5 shadow-sm font-sans flex flex-col justify-between h-full">
      <div className="flex justify-between items-start">
        <div className="min-w-0 font-sans">
          ...
          <p className="text-[12px] font-medium text-slate-500 uppercase tracking-widest leading-none">
            {title}
          </p>
      ...
      {trend && (
        <div className="flex items-center gap-1.5 mt-3 font-sans">
          <div className={`flex items-center gap-0.5 text-[12px] font-medium ${trend.isUp ? 'text-emerald-600' : 'text-rose-600'}`}>
