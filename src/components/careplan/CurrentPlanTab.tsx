        ...
        <div className="p-7">
          <div className="flex justify-between items-start mb-8">
            <div>
              ...
              <p className="text-blue-200 text-[10px] font-medium tracking-[0.15em] uppercase opacity-90">
                Current Strategy
              </p>
              {isEditing ? (
                <input 
            ...
            <div className="bg-emerald-500 text-white text-[10px] font-bold px-4 py-1.5 rounded-full shadow-lg uppercase tracking-wider">
              On Track
            </div>
          </div>
          ...
          <div className="mb-8">
            ...
            <p className="text-blue-100 text-[10px] font-medium uppercase tracking-widest mb-3 flex items-center gap-2">
